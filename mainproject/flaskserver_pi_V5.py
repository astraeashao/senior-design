...
STEP_Max = 200*13 #200 STEP = 360° When Count >= 200, CW = 0 and turn reverse, 13s turn to reach the end
    ...
    while True:
        if tfstate == False:
            ...
            try:
                ...
                pass
def tflite_predict():
    global tfstate,audiolist,nowstate,laststate,tflite_model,snoringcount,STEP_Action,STEP_Blockflag,STEP_Blocktimer,STEP_Blocktime,STEP_Max
                ...
                try:
                    ...
                    if classes[pred] == 'snoring':
                        ...
                        if STEP_Blockflag == False:
                            ...
                            STEP_Action = STEP_Action + STEP_Max/8 #step action increase, 8 is total turns
                    else:
